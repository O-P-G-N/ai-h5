<template>
	<view class="history">
		<u-navbar @leftClick="goBackUser" :leftText="$t('user.about.i1')" :title="$t('user.capital_flow.i101')" :safeAreaInsetTop="false">
			...
			<view class="list-body" v-for="(v,i) in lists" :key="i">
				<view class="capital">
					<view class="capital_top">
						...
						<text>{{$t('user.capital_flow.i101')}}</text>
					</view>
					<view class="orderhao">
						<text>{{$t('user.capital_flow.i97')}}</text>
						<text>{{v.aai}}</text>
					</view>
					<view class="orderhao">
					...
					<view class="orderhao">
						...
						<text>1 USDT={{v.aai2usdt}}ALITA</text>
					</view>
					<view class="orderhao">
